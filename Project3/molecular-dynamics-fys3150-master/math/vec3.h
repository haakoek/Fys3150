...
public:
    ...
    inline void setX(double x) { m_vec[0]=x; }
    inline void setY(double y) { m_vec[1]=y; }
    inline void setZ(double z) { m_vec[2]=z; }
    inline void addX(double x) { m_vec[0]+=x; }
    inline void addY(double y) { m_vec[1]+=y; }
    inline void addZ(double z) { m_vec[2]+=z; }
